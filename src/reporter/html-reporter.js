...
<div class="container">
  ...
  <div class="footer">Generated by NodeSlim v${escapeHtml(report.meta.version)} — <a href="https://github.com/your-org/nodeslim" style="color:#667eea">GitHub</a> &nbsp;|&nbsp; ${new Date().toISOString()}</div>
</div>
</body></html>`;
}
